...
GENERAL_TOPICS = [
    ...
    {"title_hint": "الاعتماد على أدوات النظام في الهجوم",  "category": "تقنية",  "slug": "lolbas-techniques"},
    ...
    {"title_hint": "Impacket: الأدوات المتعددة الاستخدامات للـ Red Team",  "category": "أداة",   "slug": "impacket-guide"},
    ...
    {"title_hint": "Ransomware تحليل هجوم كامل",                 "category": "تحليل",  "slug": "ransomware-anatomy"},
...
AI_RED_TEAM_TOPICS = [
    ...
    {"title_hint": "RAG Poisoning: التلاعب بـ قواعد المعرفة",              "category": "الأمن الهجومي في الذكاء الاصطناعي", "slug": "rag-poisoning"},
    {"title_hint": "AI Agent Hijacking: السيطرة على وكلاء الذكاء الاصطناعي", "category": "الأمن الهجومي في الذكاء الاصطناعي", "slug": "ai-agent-hijacking"},
    {"title_hint": "Model Extraction: استخراج نماذج الذكاء الاصطناعي",   "category": "الأمن الهجومي في الذكاء الاصطناعي", "slug": "model-extraction"},
    {"title_hint": "Adversarial Examples: التحايل على أنظمة الرؤية الاصطناعية", "category": "الأمن الهجومي في الذكاء الاصطناعي", "slug": "adversarial-examples"},
    ...
    {"title_hint": "AI Supply Chain: التلاعب بـ بيانات التدريب",           "category": "الأمن الهجومي في الذكاء الاصطناعي", "slug": "ai-supply-chain-poisoning"},
